...
export default function QrCodePurchase(props) {
  ...
  const downloadBase64Image = (imageUrl) => {
  ...
  console.log(props?.qr, 'what is purchase qr')

  return (
    <div className="glass-card p-0 ">
      <div className="w-100  qr-header"></div>
      ...
      <div className="qr-body  w-100">
        {props?.purchase ? (
          ...
          <div
            ...
            className="primary-btn px-2 py-2 "
          >
            <h3>
              {props?.heading &&
                `${props?.heading?.name || "Package Name"}  $${props?.heading?.price || "$0"
                }   `}{" "}
            </h3>
          </div>
        )}
        ...
        {!props?.qr ? (
          ...
          <div className="py-3 bar-bg">
            <img
              ...
              alt="bar-bg"
            />
            <div className="pt-2 d-flex qr-profile align-items-center justify-content-center ">
              <img
                style={{
                  borderRadius: "50%",
                  objectFit: "cover",
                ...
                src={`${import.meta.env.VITE_BASE_URL_IMAGE}${props?.qr?.user?.picture
                  }`}
                alt="bar-bg"
              />
              <label> {props?.qr?.user?.full_name}</label>
            </div>
          </div>
        )}
      </div>
