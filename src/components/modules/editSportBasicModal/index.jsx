...
const EditSportBasicModal = ({
    ...
    useEffect(() => {
        if (sportData) {
            if (sportData?.profile_detail?.sport_picture) {
                setValue("image", {
                ...
                setPreview(
                    `${import.meta.env.VITE_BASE_URL_IMAGE}${sportData?.profile_detail?.sport_picture}`
                );
            }

            if (sportData?.profile_detail?.team_name) {
                setValue("team_name", sportData?.profile_detail?.team_name);
            }
            if (sportData?.profile_detail?.positions) {
                setValue("position", sportData?.profile_detail?.positions);
            }
            if (sportData?.profile_detail?.jersey_no) {
                setValue("jersey_number", sportData?.profile_detail?.jersey_no);
            }
            if (sportData?.profile_detail?.dominant_hand) {
                //setValue("full_name", sportData?.profile_detail?.full_name);
                setValue("side", sportData?.profile_detail?.dominant_hand);
            }
...
export default EditSportBasicModal;
