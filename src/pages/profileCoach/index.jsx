              ...
              <div className="glass-bg player-profile w-100">
                <div className="w-100 ">
                  ...
                  <div className="detail-items w-100">
                    <h4>Full Name</h4>
                    <h4>{data?.profileDetail?.full_name}</h4>
                  </div>
                  <div className="detail-items w-100">
                    <h4>Email</h4>
                    <h4>{data?.profileDetail?.email}</h4>
                  </div>
                  <div className="detail-items w-100">
                    <h4>Phone</h4>
                    <h4>{data?.profileDetail?.phone}</h4>
                  </div>
                  <div className="detail-items w-100">
                    <h4>Relation</h4>
                    <h4>{data?.profileDetail?.meta?.organization_name} </h4>
                  </div>
                  <div className="detail-items w-100">
                    <h4>coach role</h4>
                    <h4>{data?.profileDetail?.meta?.coach_role} </h4>
                  </div>
                </div>
              </div>
            </Col>
